import { Text, HTMLChakraProps, useToast, chakra, Stack, FormControl, FormLabel, Input, Button, Modal, ModalBody, ModalContent, ModalOverlay } from "@chakra-ui/react";
import { AuthProvider, EmailAuthProvider, getAuth, GoogleAuthProvider, linkWithPopup, signInWithEmailAndPassword, signInWithPopup, signInWithRedirect } from "firebase/auth";
